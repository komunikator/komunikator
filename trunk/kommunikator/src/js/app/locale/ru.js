...
app.msg = {
    ...
    time: 'Время',
    time_current: 'Время',//может быть, "текущее время"
    status: 'Статус',
    ...
    busy_here: "занят",
    transfer: "переведённый",//"Переадресован"?
    temporarily_unavailable: "недоступен",//Почему тут нету "временно", а в следующем есть? 
    ...
    auto_dhcp: 'Получить IP адрес автоматически',//Однократно? Если каждый раз при подключении - то подключАть, наверное.
    ...
    warning_pwd: 'Новый пароль повторен неправильно',//"Пароли не совпадают"?
