...
// $data =  compact_array(query_to_array("SELECT extension as id, groups.group as name FROM groups union SELECT extension as id, extension as name from extensions "/*.get_sql_order_limit()*/));
$data =  compact_array(query_to_array("SELECT extension as id, groups.group as name FROM groups WHERE group_id!=1 union SELECT extension as id, extension as name FROM extensions"/*.get_sql_order_limit()*/));
